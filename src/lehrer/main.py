...
class Lehrer:
        ...
        container = (
            ...
            .with_exec(
                [
                    ...
                    "/openedx/edx-platform/lms/envs/mitol/assets.py",
                ]
            )
            .with_exec(
                [
                    ...
                    "/openedx/edx-platform/lms/envs/mitol/i18n.py",
                ]
            )
            .with_exec(
                [
                    ...
                    "/openedx/edx-platform/cms/envs/mitol/assets.py",
                ]
            )
            .with_exec(
                [
    ...
    def fetch_translations(
        ...
        container = container.with_env_variable(
            "DJANGO_SETTINGS_MODULE", "lms.envs.mitol.i18n"
        ...
        container = (
            container.with_env_variable("DJANGO_SETTINGS_MODULE", "cms.envs.mitol.i18n")
            .with_exec(
    ...
    async def build_platform(
        ...
        container = self.docker_image(
            container, deployment_name=deployment_name, release_name=release_name
        )
    ...
    async def build_mfe(
        ...
        if enable_smoot_design and is_learning_mfe:
            container = (
                container.with_exec(["npm", "pack", "@mitodl/smoot-design@^6.12.0"])

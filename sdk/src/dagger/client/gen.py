...
class Container(Type):
    ...
    async def publish(self, address: str, *, platform_variants: "list[Container] | None" = None, forced_compression: ImageLayerCompression | None = None, media_types: ImageMediaTypes | None = ImageMediaTypes.OCIMediaTypes,) -> str:
    ...
    def with_directory(self, path: str, source: "Directory", *, exclude: list[str] | None = None, include: list[str] | None = None, gitignore: bool | None = False, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_file(self, path: str, source: "File", *, permissions: int | None = None, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_files(self, path: str, sources: list["File"], *, permissions: int | None = None, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_mounted_cache(self, path: str, cache: CacheVolume, *, source: "Directory | None" = None, sharing: CacheSharingMode | None = CacheSharingMode.SHARED, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_mounted_directory(self, path: str, source: "Directory", *, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_mounted_file(self, path: str, source: "File", *, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_mounted_secret(self, path: str, source: "Secret", *, owner: str | None = '', mode: int | None = 256, expand: bool | None = False,) -> Self:
    ...
    def with_new_file(self, path: str, contents: str, *, permissions: int | None = 420, owner: str | None = '', expand: bool | None = False,) -> Self:
    ...
    def with_unix_socket(self, path: str, source: "Socket", *, owner: str | None = '', expand: bool | None = False,) -> Self:
...
class Directory(Type):
    ...
    def docker_build(self, *, dockerfile: str | None = 'Dockerfile', platform: Platform | None = None, build_args: list[BuildArg] | None = None, target: str | None = '', secrets: "list[Secret] | None" = None, no_init: bool | None = False,) -> Container:
    ...
    def with_directory(self, path: str, source: Self, *, exclude: list[str] | None = None, include: list[str] | None = None, gitignore: bool | None = False, owner: str | None = '',) -> Self:
...
class Env(Type):
    ...
    def with_address_input(self, name: str, value: Address, description: str,) -> Self:
    ...
    def with_cache_volume_input(self, name: str, value: CacheVolume, description: str,) -> Self:
    ...
    def with_changeset_input(self, name: str, value: Changeset, description: str,) -> Self:
    ...
    def with_check_group_input(self, name: str, value: CheckGroup, description: str,) -> Self:
    ...
    def with_check_input(self, name: str, value: Check, description: str,) -> Self:
    ...
    def with_cloud_input(self, name: str, value: Cloud, description: str,) -> Self:
    ...
    def with_container_input(self, name: str, value: Container, description: str,) -> Self:
    ...
    def with_directory_input(self, name: str, value: Directory, description: str,) -> Self:
    ...
    def with_env_file_input(self, name: str, value: "EnvFile", description: str,) -> Self:
    ...
    def with_env_input(self, name: str, value: Self, description: str,) -> Self:
    ...
    def with_file_input(self, name: str, value: "File", description: str,) -> Self:
    ...
    def with_git_ref_input(self, name: str, value: "GitRef", description: str,) -> Self:
    ...
    def with_git_repository_input(self, name: str, value: "GitRepository", description: str,) -> Self:
    ...
    def with_json_value_input(self, name: str, value: "JSONValue", description: str,) -> Self:
    ...
    def with_module_config_client_input(self, name: str, value: "ModuleConfigClient", description: str,) -> Self:
    ...
    def with_module_input(self, name: str, value: "Module", description: str,) -> Self:
    ...
    def with_module_source_input(self, name: str, value: "ModuleSource", description: str,) -> Self:
    ...
    def with_search_result_input(self, name: str, value: "SearchResult", description: str,) -> Self:
    ...
    def with_search_submatch_input(self, name: str, value: "SearchSubmatch", description: str,) -> Self:
    ...
    def with_secret_input(self, name: str, value: "Secret", description: str,) -> Self:
    ...
    def with_service_input(self, name: str, value: "Service", description: str,) -> Self:
    ...
    def with_socket_input(self, name: str, value: "Socket", description: str,) -> Self:
    ...
    def with_string_input(self, name: str, value: str, description: str,) -> Self:
...
class Function(Type):
    ...
    def with_arg(self, name: str, type_def: "TypeDef", *, description: str | None = '', default_value: JSON | None = None, default_path: str | None = '', ignore: list[str] | None = None, source_map: "SourceMap | None" = None, deprecated: str | None = None,) -> Self:
...
class GitRef(Type):
    ...
    def tree(self, *, discard_git_dir: bool | None = False, depth: int | None = 1,) -> Directory:
...
class Module(Type):
    ...
    def checks(self, *, include: list[str] | None = None,) -> CheckGroup:
    ...
    async def serve(self, *, include_dependencies: bool | None = None,) -> Void | None:
...
class Client(Root):
    ...
    def env(self, *, privileged: bool | None = False, writable: bool | None = False,) -> Env:
    ...
    def http(self, url: str, *, name: str | None = None, permissions: int | None = None, auth_header: "Secret | None" = None, experimental_service_host: "Service | None" = None,) -> File:
    ...
    def load_function_call_arg_value_from_id(self, id: FunctionCallArgValueID) -> FunctionCallArgValue:
